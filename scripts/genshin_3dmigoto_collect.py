...
def main():
    ...
    parser.add_argument("--force_overwrite", action='store_true', help="Automatically overwrite existing output folder without prompting")
    ...
    if not os.path.isdir(character):
        ...
        print(f"WARNING: Overwriting existing {character} folder (--force_overwrite enabled)")
    else:
